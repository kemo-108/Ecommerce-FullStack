      ...
      <section className="about-strip">
        <div className="container about-strip-inner">
          ...
          <div className="about-content">
            ...
            <h2>Your all-in-one educational partner</h2>
            <p>
              For over 15 years, Art Corner has been a trusted supplier for
              nurseries, schools and offices — from a single pen to a full
              classroom setup. We focus on durable, high-quality products
              and a shopping experience that feels simple and reliable.
            </p>
